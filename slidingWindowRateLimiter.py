...
class SlidingWindowRateLimiter:
    ...
    def _cleanup_window(self, user_id: str, current_time: float) -> None:
        ...
        # Видаляємо застарілі запити з вікна
        while (
        ...
        # Якщо всі запити очищено — видаляємо користувача з історії
    ...
    def can_send_message(self, user_id: str) -> bool:
        ...
        # Перевіряємо, чи є місце для нового запиту у вікні
    ...
    def time_until_next_allowed(self, user_id: str) -> float:
        ...
        # Час до дозволу наступного повідомлення (кінець вікна мінус поточний час)
