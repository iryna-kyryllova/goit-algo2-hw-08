...
class ThrottlingRateLimiter:
    def __init__(self, min_interval: float = 10.0):
        ...
        # Час останнього повідомлення для кожного користувача
    ...
    def can_send_message(self, user_id: str) -> bool:
        ...
        # Перевіряємо, чи минув мінімальний інтервал між повідомленнями
    ...
    def time_until_next_allowed(self, user_id: str) -> float:
        ...
        # Розраховуємо залишок часу до дозволеного повідомлення
        current_time = time.time()
        last_time = self.last_message_time[user_id]
